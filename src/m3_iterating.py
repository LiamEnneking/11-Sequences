...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 2
    actual = count_negatives((123, 1923, -918, -0.12313123))
    print()
    ...
    # Test 7:
    expected = 3
    actual = count_negatives((-239391, 84519, -12348, -3))
    print()
...
def count_short_ones(seq_of_lists):
    ...
    total = 0
    for i in range(0, len(seq_of_lists), 1):

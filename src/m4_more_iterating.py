...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [533535, 84, 3535535, 58766767, -10, 40]
    threshold = 8344
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    expected = 2  # Trust me!
    actual = count_positive_sines([2, 3, 4, 5, 12])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 259
    actual = sum_first_n([13, -23, 23, 123, 123], 5)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
